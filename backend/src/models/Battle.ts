...
interface BattleEvent {
  event: "opponent_found" | "player_entered" | "opponent_entered" | "opponent_canceled" | "ludoCode_set" | "settled";
  timestamp: Date;
...
interface Dispute {
  ...
  proofs: { player: string; filename: string;  path: string ; reason: string; adminReason: string; clicked: string | null;  }[]; // Screenshot uploads
  resolved: boolean;
